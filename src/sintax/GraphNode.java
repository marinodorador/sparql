...
/*
 * FIRST(GraphNode) = {
 * 						VAR1, VAR2, IRIref, STRING_LITERAL1, STRING_LITERAL2,STRING_LITERAL_LONG1,STRING_LITERAL_LONG2, 
...
public class GraphNode extends Production{
	public boolean analize() throws IOException{
		switch($.current.token){
			case VAR1: case VAR2: case IRI_REF: case STRING_LITERAL1: case STRING_LITERAL2:
